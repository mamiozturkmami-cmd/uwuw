...
Multi-language support (EN / TR) - No Payment API / With Capture Version
================================================================================
"""
...
LANGUAGES = {
    'en': {
        ...
        'hits_caption': "🟢 Found Premium/Valid Accounts (Hits)",
    ...
    'tr': {
        ...
        'hits_caption': "🟢 Bulunan Premium/Geçerli Hesaplar (Hits)",
